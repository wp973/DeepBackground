...
from general.generate_PSF import PSF
from general.generate_trajectory import Trajectory
...
if __name__ == '__main__':
    folder = 'd:/a_github/original_images/'
    folder_to_save = 'd:/a_github/motion_blur-36/'
    params = [0.01, 0.009, 0.008, 0.007, 0.005, 0.003]
    for path in os.listdir(folder):
        print(path)
        trajectory = Trajectory(canvas=64, max_len=36, expl=0.005).fit()
